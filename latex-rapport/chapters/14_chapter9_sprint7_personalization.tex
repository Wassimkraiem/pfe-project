\chapter{Sprint 6 — Personalized Recommendations}

\section*{Introduction}
\addcontentsline{toc}{section}{Introduction}

Sprint 6 adds a \textbf{personalized recommendation engine} to the AR-API. The system learns
...
\subsection{Use Case Diagram for Sprint 6}
...
\end{tikzpicture}
\caption{Sprint 6 use case diagram — Recommendation System}
...
Sprint 6 introduced a \textbf{personalized recommendation engine} driven by real-time
