\chapter{Sprint 4 — Personalized Recommendations}

\section*{Introduction}
\addcontentsline{toc}{section}{Introduction}

Sprint 4 adds a \textbf{personalized recommendation engine} to the AR-API. The system learns
...
\end{tikzpicture}
\caption{Use-case diagram — Recommendation System}
\label{fig:uc_sprint6}
\end{figure}

\subsection{Class Diagram}

Figure~\ref{fig:cd_sprint4} shows the data model for the recommendation module: the three new
PostgreSQL tables (\texttt{user\_search\_events}, \texttt{user\_video\_events},
\texttt{user\_interest\_profiles}) and their relationships to the existing AR-API user model.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{\detokenize{diagrams/sprint 4 class.drawio.png}}
\caption{Class diagram — recommendation module data model}
\label{fig:cd_sprint4}
\end{figure}
...
Sprint 4 introduced a \textbf{personalized recommendation engine} driven by real-time
