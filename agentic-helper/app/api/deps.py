...
def get_rag_service() -> RagService:
    ...
    return RagService(embeddings=embeddings)


def get_chat_service(request: Request, rag: RagService = Depends(get_rag_service)) -> ChatService:
...
__all__ = ["get_db", "require_api_key", "get_user_id", "get_chat_service", "get_rag_service"]
